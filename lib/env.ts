...
const REQUIREMENTS: EnvRequirement[] = [
  ...
  { key: "UPSTASH_REDIS_REST_URL", stage: "optional", description: "Upstash Redis REST endpoint" },
  { key: "UPSTASH_REDIS_REST_TOKEN", stage: "optional", description: "Upstash Redis REST token", mask: true },
